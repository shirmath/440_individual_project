...
income_age +
  plot_annotation(caption = "Figure 2: Distribution of changes in Kessler-6 scores from Wave 1 survey to Wave 2 survey amongst participants with varying demographic characeristics of poverty status and age cohort.",
                  tag_levels = "A")

race_geo +
  plot_annotation(caption = "Figure 3: Distribution of changes in Kessler-6 scores from Wave 1 survey to Wave 2 survey amongst participants with varying demographic characeristics of racial identity and geographic region of residence.",
                  tag_levels = "A")
```
